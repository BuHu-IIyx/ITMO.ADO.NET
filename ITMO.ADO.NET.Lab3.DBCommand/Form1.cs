...
namespace ITMO.ADO.NET.Lab3.DBCommand
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            sqlCommand2.CommandText = "dbo.[Ten Most Expensive Products]";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            sqlCommand4.Parameters["@Name"].Value = CityTextBox.Text;
            sqlConnection1.Open();
        ...
        {
            System.Text.StringBuilder results = new System.Text.StringBuilder();
            sqlCommand5.Parameters["@CheckColor"].Value = CategoryNameTextBox.Text;
            sqlCommand5.Parameters["@CheckSize"].Value = OrdYearTextBox.Text;
