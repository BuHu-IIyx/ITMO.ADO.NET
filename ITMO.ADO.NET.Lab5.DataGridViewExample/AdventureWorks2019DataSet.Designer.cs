...
namespace ITMO.ADO.NET.Lab5.DataGridViewExample {
    ...
    public partial class AdventureWorks2019DataSet : global::System.Data.DataSet {
        ...
        public partial class PersonDataTable : global::System.Data.TypedTableBase<PersonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PersonRow AddPersonRow(int BusinessEntityID, string PersonType, bool NameStyle, string Title, string FirstName, string MiddleName, string LastName, string Suffix, int EmailPromotion) {
...
namespace ITMO.ADO.NET.Lab5.DataGridViewExample.AdventureWorks2019DataSetTableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Person].[Person] ([BusinessEntityID], [PersonType], [NameStyle], [Title], [FirstName], [MiddleName], [LastName], [Suffix], [EmailPromotion]) VALUES (@BusinessEntityID, @PersonType, @NameStyle, @Title, @FirstName, @MiddleName, @LastName, @Suffix, @EmailPromotion);
SELECT BusinessEntityID, PersonType, NameStyle, Title, FirstName, MiddleName, LastName, Suffix, EmailPromotion FROM Person.Person WHERE (BusinessEntityID = @BusinessEntityID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Person].[Person] SET [BusinessEntityID] = @BusinessEntityID, [PersonType] = @PersonType, [NameStyle] = @NameStyle, [Title] = @Title, [FirstName] = @FirstName, [MiddleName] = @MiddleName, [LastName] = @LastName, [Suffix] = @Suffix, [EmailPromotion] = @EmailPromotion WHERE (([BusinessEntityID] = @Original_BusinessEntityID) AND ([PersonType] = @Original_PersonType) AND ([NameStyle] = @Original_NameStyle) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ([FirstName] = @Original_FirstName) AND ((@IsNull_MiddleName = 1 AND [MiddleName] IS NULL) OR ([MiddleName] = @Original_MiddleName)) AND ([LastName] = @Original_LastName) AND ((@IsNull_Suffix = 1 AND [Suffix] IS NULL) OR ([Suffix] = @Original_Suffix)) AND ([EmailPromotion] = @Original_EmailPromotion));
SELECT BusinessEntityID, PersonType, NameStyle, Title, FirstName, MiddleName, LastName, Suffix, EmailPromotion FROM Person.Person WHERE (BusinessEntityID = @BusinessEntityID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ITMO.ADO.NET.Lab5.DataGridViewExample.Properties.Settings.Default.AdventureWorks2019ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT BusinessEntityID, PersonType, NameStyle, Title, FirstName, MiddleName, Las" +
                "tName, Suffix, EmailPromotion FROM Person.Person";
        ...
        public virtual int Delete(int Original_BusinessEntityID, string Original_PersonType, bool Original_NameStyle, string Original_Title, string Original_FirstName, string Original_MiddleName, string Original_LastName, string Original_Suffix, int Original_EmailPromotion) {
        ...
        public virtual int Insert(int BusinessEntityID, string PersonType, bool NameStyle, string Title, string FirstName, string MiddleName, string LastName, string Suffix, int EmailPromotion) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_BusinessEntityID));
            if ((Original_PersonType == null)) {
                throw new global::System.ArgumentNullException("Original_PersonType");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_PersonType));
            }
            this.Adapter.UpdateCommand.Parameters[11].Value = ((bool)(Original_NameStyle));
            if ((Original_Title == null)) {
            ...
            if ((Original_Suffix == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[19].Value = ((string)(Original_Suffix));
            }
            this.Adapter.UpdateCommand.Parameters[20].Value = ((int)(Original_EmailPromotion));
        ...
        public virtual int Update(
                    ...
                    string Original_Suffix, 
                    int Original_EmailPromotion) {
            return this.Update(Original_BusinessEntityID, PersonType, NameStyle, Title, FirstName, MiddleName, LastName, Suffix, EmailPromotion, Original_BusinessEntityID, Original_PersonType, Original_NameStyle, Original_Title, Original_FirstName, Original_MiddleName, Original_LastName, Original_Suffix, Original_EmailPromotion);
        }
    }
