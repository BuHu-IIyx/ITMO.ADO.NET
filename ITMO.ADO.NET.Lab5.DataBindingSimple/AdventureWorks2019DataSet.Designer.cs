...
namespace ITMO.ADO.NET.Lab5.DataBindingSimple {
    ...
    public partial class AdventureWorks2019DataSet : global::System.Data.DataSet {
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductRow AddProductRow(string Name, string Color, decimal ListPrice, string Size, ProductSubcategoryRow parentProductSubcategoryRowByFK_Product_ProductSubcategory_ProductSubcategoryID) {
                ...
                if ((parentProductSubcategoryRowByFK_Product_ProductSubcategory_ProductSubcategoryID != null)) {
                    columnValuesArray[5] = parentProductSubcategoryRowByFK_Product_ProductSubcategory_ProductSubcategoryID[0];
                }
...
namespace ITMO.ADO.NET.Lab5.DataBindingSimple.AdventureWorks2019DataSetTableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Production].[Product] WHERE (([ProductID] = @Original_ProductID) AND ([Name] = @Original_Name) AND ((@IsNull_Color = 1 AND [Color] IS NULL) OR ([Color] = @Original_Color)) AND ([ListPrice] = @Original_ListPrice) AND ((@IsNull_Size = 1 AND [Size] IS NULL) OR ([Size] = @Original_Size)) AND ((@IsNull_ProductSubcategoryID = 1 AND [ProductSubcategoryID] IS NULL) OR ([ProductSubcategoryID] = @Original_ProductSubcategoryID)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Production].[Product] SET [Name] = @Name, [Color] = @Color, [ListPrice] = @ListPrice, [Size] = @Size, [ProductSubcategoryID] = @ProductSubcategoryID WHERE (([ProductID] = @Original_ProductID) AND ([Name] = @Original_Name) AND ((@IsNull_Color = 1 AND [Color] IS NULL) OR ([Color] = @Original_Color)) AND ([ListPrice] = @Original_ListPrice) AND ((@IsNull_Size = 1 AND [Size] IS NULL) OR ([Size] = @Original_Size)) AND ((@IsNull_ProductSubcategoryID = 1 AND [ProductSubcategoryID] IS NULL) OR ([ProductSubcategoryID] = @Original_ProductSubcategoryID)));
SELECT ProductID, Name, Color, ListPrice, Size, ProductSubcategoryID FROM Production.Product WHERE (ProductID = @ProductID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ITMO.ADO.NET.Lab5.DataBindingSimple.Properties.Settings.Default.AdventureWorks2019ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductID, Name, Color, ListPrice, Size, ProductSubcategoryID FROM Product" +
                "ion.Product";
        ...
        public virtual int Fill(AdventureWorks2019DataSet.ProductDataTable dataTable) {
        ...
        public virtual AdventureWorks2019DataSet.ProductDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AdventureWorks2019DataSet.ProductDataTable dataTable = new AdventureWorks2019DataSet.ProductDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AdventureWorks2019DataSet.ProductDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ProductID, string Original_Name, string Original_Color, decimal Original_ListPrice, string Original_Size, global::System.Nullable<int> Original_ProductSubcategoryID) {
        ...
        public virtual int Update(string Name, string Color, decimal ListPrice, string Size, global::System.Nullable<int> ProductSubcategoryID, int Original_ProductID, string Original_Name, string Original_Color, decimal Original_ListPrice, string Original_Size, global::System.Nullable<int> Original_ProductSubcategoryID, int ProductID) {
            if ((Name == null)) {
            ...
            if ((ProductSubcategoryID.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(ProductSubcategoryID.Value));
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((decimal)(Original_ListPrice));
            if ((Original_Size == null)) {
            ...
            if ((Original_ProductSubcategoryID.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(Original_ProductSubcategoryID.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Color, decimal ListPrice, string Size, global::System.Nullable<int> ProductSubcategoryID, int Original_ProductID, string Original_Name, string Original_Color, decimal Original_ListPrice, string Original_Size, global::System.Nullable<int> Original_ProductSubcategoryID) {
            return this.Update(Name, Color, ListPrice, Size, ProductSubcategoryID, Original_ProductID, Original_Name, Original_Color, Original_ListPrice, Original_Size, Original_ProductSubcategoryID, Original_ProductID);
        }
    }
...
SELECT ProductSubcategoryID, ProductCategoryID, Name, rowguid, ModifiedDate FROM Production.ProductSubcategory WHERE (ProductSubcategoryID = @ProductSubcategoryID)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(AdventureWorks2019DataSet.ProductSubcategoryDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual AdventureWorks2019DataSet.ProductSubcategoryDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AdventureWorks2019DataSet.ProductSubcategoryDataTable dataTable = new AdventureWorks2019DataSet.ProductSubcategoryDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AdventureWorks2019DataSet.ProductSubcategoryDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
