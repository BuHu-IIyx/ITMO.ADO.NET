    ...
    public partial class Form1 : Form
    {
        private NorthwindDataSet.CustomersRow GetSelectedRow()
        {
            ...
            NorthwindDataSet.CustomersRow SelectedRow =
                    northwindDataSet1.Customers.FindByCustomerID(Convert.ToInt64(SelectedCustomerID));
            return SelectedRow;
        }
        ...
        private void AddRowButton_Click(object sender, EventArgs e)
        {
            ...
            NewRow.CustomerID = 23;
            NewRow.CustomerTitleId = 5;
            NewRow.CustomerFirstName = "Dany";
            NewRow.CustomerOtherInitials = "P";
            NewRow.CustomerLastName = "Monat";
            NewRow.AddressId = 12;
            NewRow.AccountNumber = "124532562";
            NewRow.AccountTypeId = 123;
            NewRow.CleareBalance = 12435;
            NewRow.UnclearBalance = 2324;
